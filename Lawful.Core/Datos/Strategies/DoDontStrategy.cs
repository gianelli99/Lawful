...
namespace Lawful.Core.Datos.Strategies
{
    public class DoDontStrategy : IQueryStrategy
    {
        ...
        public SqlCommand SetInsertCommand(SqlCommand command, Iniciativa iniciativa)
        {
            ...
            command.Parameters.AddWithValue("@fecha_evento", dodont.FechaEvento);
            command.Parameters.AddWithValue("@lugar", dodont.Lugar);
            command.Parameters.AddWithValue("@fecha_limite_confirmacion", dodont.FechaLimiteConfirmacion);
